 ...
 * label.
 *
 * # Options # {#ct-label-options}
 *
 * The following options are available :
 *
 * - `property` (string) : Name of the property; Defaults to "id"
 * - `labels` (string) : A coma-separated list of value=label to use. Defaults
 *   to "0=false,1=true"
 *
